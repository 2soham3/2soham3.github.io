...
Studied in particular the proof, ' If '''math S ''' is a compact surface with finitely many marked points, then the group '''math Mod(S)''' is finitely presented', from the book 'A Primer on Mapping Class Group' by Benson Farb and Dan Margalit. 
